...
mkdir -p images
mkdir -p data/outputs/flux_fill_grpo
...
echo "Step 2: Starting Flux Fill GRPO training..."
...
uv run torchrun --nproc_per_node=4 --master_port 19004 \
    ...
    --allow_tf32 \
    --cfg 0.0 \
    --output_dir data/outputs/flux_fill_grpo \
    --final_model_dir data/outputs/flux_fill_grpo_final \
    --h 1024 \
    --w 1024 \
    --sampling_steps 20 \
    --eta 0.3 \
